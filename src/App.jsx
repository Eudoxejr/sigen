...
function App() {
  ...
  return (
    ...
    <div className=" bg-blue-gray-50 flex flex-col flex-1 w-screen h-screen overflow-y-scroll scrollbar-thin overflow-x-hidden " >
      ...
      <Routes>
        ...
        >
          ...
          <Route path="groupes-categories">
            <Route index element={<CategoriesGroup/>} />
          </Route>
