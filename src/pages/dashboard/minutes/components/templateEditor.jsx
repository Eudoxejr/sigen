...
const TemplateEdit = () => {
    ...
    return (<div className="control-pane">
        <div className="control-section mt-3 flex flex-row ">
            {/* <div id="documenteditor_titlebar" className="e-de-ctn-title flex  "></div> */}
            <div className="w-[20%] max-w-[200px] control-section " style={{
            ...
            <div className=" w-[80%] control-section" style={{ paddingLeft: "0px", paddingRight: "0px", paddingTop: "0px" }}>
                <DocumentEditorContainerComponent id="container" ref={container} style={{ display: "block" }} height={"850px"} serviceUrl={hostUrl} enableToolbar={true} locale="fr-FR" />
            </div>
        </div>
