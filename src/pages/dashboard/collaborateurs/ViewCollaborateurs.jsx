        ...
        <CardBody className="py-4 mt-4">
          ...
          <div className="mb-5 flex items-center justify-between gap-6 ">
              ...
              <div className="flex items-center gap-6">
                <PhotoView key={dataSpecificCollabo?.id} src={dataSpecificCollabo?.profil_pic || '/img/sigen/user128.png'}>
                  <Avatar
                    src={dataSpecificCollabo?.profil_pic || "/img/sigen/user.png"}
                    alt=""
                    size="xl"
                ...
                <div>
                  <Typography variant="h5" color="blue-gray" className="mb-1">
                    {dataSpecificCollabo?.firstname+" "+dataSpecificCollabo?.lastname}
                  </Typography>
              ...
              <div className=" min-w-[300px] flex flex-col flex-1 " >
                ...
                <div className="w-full h-full py-3 flex items-center flex-col justify-center" >
                  ...
                  <div className="w-full flex justify-between mb-1" >
                    ...
                    <span className="font-medium opacity-75 text-[15px] capitalize" >{parseInt(dataSpecificCollabo.meta.folderManage_count)+parseInt(dataSpecificCollabo.meta.folderSubManage_count)}</span>
                  </div>
                  ...
                  <div className="w-full mt-4 flex justify-between mb-1" >
                    ...
                    <span className="font-medium opacity-75 text-[15px] capitalize">{parseInt(dataSpecificCollabo.meta.folderManage_count)}</span>
                  </div>
                  <Progress value={(parseInt(dataSpecificCollabo.meta.folderManage_count)*100)/(parseInt(dataSpecificCollabo.meta.folderManage_count)+parseInt(dataSpecificCollabo.meta.folderSubManage_count))} color="green" />

                  <div className="w-full mt-4 flex justify-between mb-1" >
                    <span className="font-medium opacity-75 text-[14.5px] capitalize">Suppléant</span>
                    <span className="font-medium opacity-75 text-[15px] capitalize">{parseInt(dataSpecificCollabo.meta.folderSubManage_count)}</span>
                  </div>
                  <Progress value={(parseInt(dataSpecificCollabo.meta.folderSubManage_count)*100)/(parseInt(dataSpecificCollabo.meta.folderManage_count)+parseInt(dataSpecificCollabo.meta.folderSubManage_count))} color="deep-orange" />
              ...
              <div className=" w-[300px] " >
                ...
                <div className=" w-full flex flex-row gap-4 flex-wrap " >
...

                  {
                    ...
                    !dataSpecificCollabo.is_suspend ?
                      <button
                        onClick={() =>
                          setDialogue({
                            size: "xs",
                            ...
                            data: {...dataSpecificCollabo, wasActive: true}
                          })
                        }
                      ...
                      <button
                        onClick={() =>
                          setDialogue({
                            ...
                            open: true,
                            view: "suspend-collaborateur",
                            data: {...dataSpecificCollabo, wasActive: false}
                          })
                        }
