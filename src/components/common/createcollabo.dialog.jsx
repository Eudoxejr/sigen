...
function CreateCollaborateur() {
    ...
    const { mutate, isLoading } = useMutation({
        ...
        mutationFn: async (data) => {
            return CollaboApi.createCollabo(data)
        },
        gcTime: 0,
        onSuccess: (response) => {
    ...
    return (
        ...
        <>
            ...
            <DialogHeader className='text-sm ' >Ajouter un nouveau collaborateur</DialogHeader>
                ...
                <div className=' w-full flex flex-row flex-wrap justify-center mt-[20px] gap-y-[20px] gap-x-[30px]' >
                    ...
                    <Controller
                        render={({
                            ...
                            <div className=" min-w-[280px] w-[300px] " >
                                <Input onChange={onChange} value={value} type="tel" color="blue-gray" label="Email" size="lg" error={invalid} />
                                {error &&
                                    <span className=" text-[11px] text-red-400 mt-1" >{error.message}</span>
                                }
                            </div>
...
export default CreateCollaborateur